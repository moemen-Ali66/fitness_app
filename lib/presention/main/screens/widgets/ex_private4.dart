...
class ExPrivate4 extends StatefulWidget {
  const ExPrivate4({Key? key}) : super(key: key);

  @override
  State<ExPrivate4> createState() => _ExPrivate4State();
}
class _ExPrivate4State extends State<ExPrivate4> {
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                      image: AssetImage('assets/images/cat5.jpg'),
                      fit: BoxFit.fill)),
            ),
            const SizedBox(
              height: 20,
            ...
            Expanded(
              child: ListView.separated(
                  ...
                  itemBuilder: (context, index) =>
                      buildItemex(exs5[index], context),
...
Widget buildItemex(ExModel5 model, context) => GestureDetector(
      child: Padding(
