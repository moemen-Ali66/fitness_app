...
class ExPrivate2 extends StatefulWidget {
  const ExPrivate2({Key? key}) : super(key: key);

  @override
  State<ExPrivate2> createState() => _ExPrivate2State();
}
class _ExPrivate2State extends State<ExPrivate2> {
  @override
            ...
            Expanded(
              child: ListView.separated(
                  ...
                  itemBuilder: (context, index) =>
                      buildItemex(exs3[index], context),
...
Widget buildItemex(ExModel3 model, context) => GestureDetector(
      child: Padding(
